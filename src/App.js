...
function App() {
  ...
  return (
    <div className="flex flex-col bg-gradient-to-br from-neutral-900 via-purple-800 to-blue-800 text-white items-center justify-center h-screen px-4 sm:px-20 transition-all ease-in-out">
      <h1 className="mb-8 text-5xl font-bold text-[#aed0f9] drop-shadow-lg hover:text-[#89b9f5]">Speed Typing Game</h1>
      <div className="mb-4">
